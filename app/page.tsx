				...
				<section className="flex gap-4 justify-between w-full px-4 relative">
					<div className="w-3/4 px-2">
						...
						<div className="py-10 flex items-center justify-between">
							<h1 className="text-xl font-medium ">Learning Overview</h1>
							<Button
					...
					{/* Right */}
					<div className="w-1/4">
						<div className="text-black bg-white px-3 py-4 flex flex-col gap-5 rounded-lg shadow h-1/3 flex items-center justify-center h-full">
							...
							{/* <div className=" text-[1.3em] bg-slate-100 px-1 py-1 shadow-lg">
								<h1 className="text-sm text-[.9em]">Upcoming event</h1>
							</div> */}
						</div>
					</div>
				</section>
