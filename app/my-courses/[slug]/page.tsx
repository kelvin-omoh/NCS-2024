...
const Page: React.FC<PageProps> = ({ params }: { params: { slug: any } }) => {
    ...
    return (
        <>
            {course !== null && <div className='flex justify-between gap-7'>
                ...
                <div className='bg-white px-3 py-5 rounded-lg w-[90rem]  '>
                    <div className='flex flex-col justify-between '>
                        ...
                        <h1 className='text-[1.1em] font-bold'>2 of {course.units} </h1>
                    </div>
                    {/* <Progress
      label=""
      size="sm"
                        ...
                        <div className=' '>
                            {courseDetails.map((courseDetails, i) => (
                                <div className="relative  text-lg">
                                    ...
                                    <h1 className="mt-2 text-gray-400 text-sm  block border-l-4 w-[20em] border-dotted px-4">Last Accessed:{courseDetails.date}</h1>
