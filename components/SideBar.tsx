...
const SideBar = () => {
          ...
          >
            <div className="flex-1 w-0 p-4">
              <div className="flex items-start">
                ...
                <Image className=' h-[2rem] w-[2rem] flex flex-col mx-3 rounded-full ' src={Logo} alt=''/>
                </div>
  ...
  return (
    <div className=' h-[100vh] shadow-xl px-7  fixed top-0 left-0  bg-[white] w-1/6'>
      <ul className=' mb-9'>
        <li className=' flex   text-[1.4em] pt-9 font-bold items-center'><Image className=' h-[2rem] w-[2rem] flex flex-col mx-3 rounded-full ' src={Logo} alt=''/> LearnVerse</li>
      </ul>
